...
module.exports = { session: process.env.SESSION_ID || 'keith',
    ...
    GITHUB : process.env.GITHUB|| 'https://github.com/NjabuloJ/Queen-grills',
    ...
    AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || '🦋ǫᴜᴇᴇɴ ɢʀɪʟʟs🦋',   
    ...
    CAPTION : process.env.CAPTION || "Queen-grills",
    BOT : process.env.BOT_NAME || 'Queen-grills',
